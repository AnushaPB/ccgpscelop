...
run_go <- function(org_key){  
    ...
    go_result <-
        gost(
            ...
            ordered_query = FALSE, 
            # multi_query: In case of multiple gene lists, returns comparison table of these lists. 
            multi_query = FALSE, 
            ...
            # evcodes: Include evidence codes to the results. Note that this can decrease performance and make the query slower. 
            evcodes = TRUE, 
            ...
            numeric_ns = "", 
            # sources: A vector of data sources to use. Currently, these include GO (GO:BP, GO:MF, GO:CC to select a particular GO branch), KEGG, REAC, TF, MIRNA, CORUM, HP, HPA, WP.
            sources = NULL, 
