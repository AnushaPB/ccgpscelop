...
PLINK=$BASE_PATH/58-Sceloporus_annotated_pruned_0.6

plink --bfile $PLINK --allow-extra-chr --autosome-num 95 --distance square 1-ibs --const-fid --out outputs/58-Sceloporus_annotated_pruned_0.6