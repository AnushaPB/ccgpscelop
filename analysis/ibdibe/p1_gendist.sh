...
plink --bfile ../gea/outputs/nonsyn --allow-extra-chr --autosome-num 95 --distance square 1-ibs --const-fid --out outputs/nonsyn

plink --bfile ../gea/outputs/genes --allow-extra-chr --autosome-num 95 --distance square 1-ibs --const-fid --out outputs/genes

plink --bfile ../gea/outputs/gea --allow-extra-chr --autosome-num 95 --distance square 1-ibs --const-fid --out outputs/gea