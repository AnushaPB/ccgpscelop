...
# Remove beckii individuals from VCF
bcftools view -S ^../data/beckii_sampleids.txt $VCF -Oz -o ../data/ccgp_data/58-Sceloporus_complete_coords_annotated_occidentalis_only.vcf.gz

bcftools view -S ^../data/beckii_sampleids.txt $PRUNED -Oz -o ../data/ccgp_data/58-Sceloporus_annotated_pruned_0.6_occidentalis_only.vcf.gz

# Convert VCF to PLINK
plink --vcf ../data/ccgp_data/58-Sceloporus_complete_coords_annotated_occidentalis_only.vcf.gz --make-bed --out ../data/ccgp_data/58-Sceloporus_complete_coords_annotated --allow-extra-chr --const-fid > vcf_to_plink.out 2> vcf_to_plink.err

plink --vcf ../data/ccgp_data/58-Sceloporus_annotated_pruned_0.6_occidentalis_only.vcf.gz --make-bed --out ../data/ccgp_data/58-Sceloporus_annotated_pruned_0.6 --allow-extra-chr --const-fid > vcf_to_plink.out 2> vcf_to_plink.err
